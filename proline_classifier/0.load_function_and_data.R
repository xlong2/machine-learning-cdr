...
direct=getwd()
if(!grepl("proline_classifier",direct)){
  setwd("./proline_classifier/")  # enter directory ./proline_classifier
...
g(the_method,each_method,cluster_dis,result_dir,subsitution_matrix,subsitution_matrix_name,plot_dir,file)%=% specify_variable_names(prefix)
...
print("line 46")
setwd("../")  # go back to proline_classifier directory
