...
plot_dir="./Plots/"
print(c("figure plotted", "./Plots/suggested_changes/gbm_improved_from_blindBLAST.pdf"))
save_figure_specific_size(p,"suggested_changes/gbm_improved_from_blindBLAST.pdf",7,7)
