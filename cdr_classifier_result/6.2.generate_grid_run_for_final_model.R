...
condor_script_dir="/Users/longxiyao/Google\ Drive/2018_spring/lab_work_data/machine_learning_cdr/cdr_classifier_result/condor_script"  # also host shell scripts no needed either way
condor_submit=FALSE
