...
for(each_loop in names(all_loop_sig_frame_list)){
  each_l_f = all_loop_sig_frame_list[[each_loop]]
  ...
  all_loop_sig_frame_list[[each_loop]] =each_l_f
...
all_frames_I_care$sig_stat=as.character(all_frames_I_care$sig_stat)
all_frames_I_care[is.na(all_frames_I_care$sig_stat),"sig_stat"]=rep("better than random",dim(all_frames_I_care[all_frames_I_care$sig_stat=="better than random and little errors",])[1])
all_frames_I_care[all_frames_I_care$sig_stat=="better than random but still many errors","sig_stat"]=rep("better than random",dim(all_frames_I_care[all_frames_I_care$sig_stat=="better than random but still many errors",])[1])
