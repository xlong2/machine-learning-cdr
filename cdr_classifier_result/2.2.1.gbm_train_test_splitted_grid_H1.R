...
getwd()
file="./Data_processed/data_by_loop_type_list_unduplicated_no_filtering_original.rds"
data_by_loop_type_list_unduplicated=readRDS(file)

# load required packages 
list.of.packages <- c("xgboost","Matrix","stats", "grid","caret","RWebLogo","MLmetrics","parallel","pryr","protr","gbm","ggplot2","ggrepel","reshape2","gridExtra","doMC","RColorBrewer","e1071")
...
args_list=list()
args_list[[1]]=args[1:6]
args_list[[2]]=data_by_loop_type_list_unduplicated
args_list[[3]]=args[7]

execute_training_rscript_comp(args_list)
